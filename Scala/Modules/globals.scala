...
object Globals
{
	...
	val title_values=Map[String,Int]("GM"->20,"IM"->10,"WGM"->6,"FM"->5,"WIM"->4,"CM"->3,"WFM"->2,"WCM"->1)

	val keystat_fields=Array("ALL","R","CR","AVGR","MF","RMF","CRMF","AVGRMF","M","RM","CRM","AVGRM","F","PARF","RF","PARFR","CRF","AVGRF","T","GM","SGM","TP")
